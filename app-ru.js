/**
 * app-ru.js
 * Main application controller for Belajar Bahasa Rusia
 */
...
class RussianLearningApp {
  constructor() {
    ...
    this.storage.STORAGE_KEY = 'learnRussian';
    ...
    modal.querySelector('.modal-content').innerHTML = `
      <div class="settings-content">
        ...
        <div class="setting-actions">
          <button class="btn btn-secondary" onclick="appRu.exportData()">Export Data</button>
          <button class="btn btn-secondary" onclick="appRu.importData()">Import Data</button>
          <button class="btn btn-danger" onclick="appRu.resetData()">Reset Semua</button>
        </div>

        <div class="setting-actions">
          <button class="btn btn-primary" onclick="appRu.saveSettings()">Simpan</button>
          <button class="btn btn-secondary" onclick="appRu.ui.closeModal('settingsModal')">Tutup</button>
        </div>
      </div>
    `;
  ...
  exportData() {
    ...
    a.href = url;
    a.download = 'russian-learning-data.json';
    a.click();

/**
 * app-de.js
 * Main application controller for Belajar Bahasa Jerman
 */
...
class GermanLearningApp {
    ...
    modal.querySelector('.modal-content').innerHTML = `
      <div class="settings-content">
        ...
        <div class="setting-actions">
          <button class="btn btn-secondary" onclick="appDe.exportData()">Export Data</button>
          <button class="btn btn-secondary" onclick="appDe.importData()">Import Data</button>
          <button class="btn btn-danger" onclick="appDe.resetData()">Reset Semua</button>
        </div>

        <div class="setting-actions">
          <button class="btn btn-primary" onclick="appDe.saveSettings()">Simpan</button>
          <button class="btn btn-secondary" onclick="appDe.ui.closeModal('settingsModal')">Tutup</button>
        </div>
      </div>
    `;
  ...
  exportData() {
    ...
    a.href = url;
    a.download = 'german-learning-data.json';
    a.click();

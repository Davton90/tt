/**
 * app-it.js
 * Main application controller for Belajar Bahasa Italia
 * Reuses modules from French/Spanish version with Italian namespace
 */

class ItalianLearningApp {
  constructor() {
    // Initialize managers with Italian namespace
    this.storage = new StorageManager();
    this.storage.STORAGE_KEY = 'learnItalian';
  ...
  exportData() {
    ...
    a.href = url;
    a.download = 'italian-learning-data.json';
    a.click();

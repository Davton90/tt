/**
 * app-es.js
 * Main application controller for Belajar Bahasa Spanyol
 * Reuses modules from French version with Spanish namespace
 */

class SpanishLearningApp {
  constructor() {
    // Initialize managers with Spanish namespace
    this.storage = new StorageManager();
    this.storage.STORAGE_KEY = 'learnSpanish';
  ...
  exportData() {
    ...
    a.href = url;
    a.download = 'spanish-learning-data.json';
    a.click();
